...
srun bash -c "hostname; python3 main_mbpo.py --env_name 'Hopper-v2' --num_epoch 100 --model_type 'pytorch' --save_dir 'exploration' --exp_name 'explo_hopper_1'"
srun bash -c "hostname; python3 main_mbpo.py --env_name 'Hopper-v2' --num_epoch 100 --model_type 'pytorch' --save_dir 'exploration' --exp_name 'explo_hopper_2'"
srun bash -c "hostname; python3 main_mbpo.py --env_name 'Hopper-v2' --num_epoch 100 --model_type 'pytorch' --save_dir 'exploration' --exp_name 'explo_hopper_3'"
srun bash -c "hostname; python3 main_mbpo.py --env_name 'Hopper-v2' --num_epoch 100 --model_type 'pytorch' --save_dir 'exploration' --exp_name 'explo_hopper_4'"
