...
## Usage
> CUDA_VISIBLE_DEVICES=3 python main_mbpo.py --env_name 'HalfCheetah-v2' --num_epoch 300 --model_type 'pytorch' --exp_name halfcheetah_en5_3 --num_networks 5 --num_elites 5 --seed 1
> 
